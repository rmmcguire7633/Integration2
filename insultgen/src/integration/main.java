...
public class main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("1 for Math, 2 for Strings (also gives a random adjetive), 3 for Classes and Objects, 4 for Arrays, 5 for Stringbuilder, 6 for the date and time, 7 for inhertiance, 8 for Lambda");
    Scanner input = new Scanner(System.in);
    String userChoice = input.nextLine();
    while (!userChoice.equals("1") && !userChoice.equals("2") && !userChoice.equals("3") && !userChoice.equals("4") && !userChoice.equals("5") && !userChoice.equals("6") && !userChoice.equals("7") && !userChoice.equals("8")) {
 ...
 // using methods
  ...
  public static void doLambdaStuff() {
    ...
    //what this is doing is going through every item with in my array list, if a number inside the array list is more than 10 then it comes back true and prints it out.
